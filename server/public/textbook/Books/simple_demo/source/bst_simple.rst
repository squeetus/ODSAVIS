...
.. raw:: html
   ...
   <script>ODSA.SETTINGS.DISP_MOD_COMP = true;ODSA.SETTINGS.MODULE_NAME = "bst_simple";ODSA.SETTINGS.MODULE_LONG_NAME = "Binary Search Trees";ODSA.SETTINGS.MODULE_CHAPTER = "A Simple Example"; ODSA.SETTINGS.BUILD_DATE = "2017-08-30 12:48:28"; ODSA.SETTINGS.BUILD_CMAP = false;JSAV_OPTIONS['lang']='en';JSAV_EXERCISE_OPTIONS['code']='java_generic';</script>
...
.. inlineav:: BSTinsertCON ss
   :long_name: Insert BST Slideshow
   :points: 0.0
   :required: False
   :threshold: 10.0
  :output: show
...
.. avembed:: AV/Binary/BSTinsertPathPRO.html pe
   :module: bst_simple
   :long_name: Insert BST path Practice
   :points: 0.0
   :required: False
   :threshold: 10.0
...
.. avembed:: AV/Binary/BSTrandinsertPRO.html pe
   :module: bst_simple
   :long_name: Random Insert BST Practice
   :points: 0.0
   :required: False
   :threshold: 10.0
   :exer_opts: JXOP-debug=true&amp;JOP-lang=en&amp;JXOP-code=java_generic
